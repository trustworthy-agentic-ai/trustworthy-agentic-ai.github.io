...
const track1: TrackData = {
  ...
  icon: Activity,
  overview:
    "MedLongTrust-EHR is a challenge for long-context trustworthy understanding of electronic health records. Models must judge whether a medical claim or response is trustworthy, identify hallucinations, privacy leaks, safety risks, and insufficient evidence, and return traceable evidence paragraphs. The current public release is based on Synthea / SyntheticMass synthetic EHR data, suitable for public evaluation and baseline development; it can be extended to authorized real clinical data.",
  task: {
